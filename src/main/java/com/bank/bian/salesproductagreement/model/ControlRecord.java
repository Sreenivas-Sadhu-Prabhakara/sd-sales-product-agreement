package com.bank.bian.salesproductagreement.model;
...
/**
 * The BIAN control record for this service domain: "Sales Product Agreement Management Plan".
 *
 ...
 * to its asset type (Sales Product Agreement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Sales Product Agreement Management Plan";
